...
- `internal/templates/sshd_config.tmpl` (new) - SSH configuration template
- `internal/templates/jail.local.tmpl` (new) - fail2ban jail configuration template
- `docs/api-specs/infrastructure/infrastructure-api.md` (updated) - Add security module API documentation
