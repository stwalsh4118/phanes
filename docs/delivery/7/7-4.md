...
- `internal/modules/devtools/devtools.go` - Integrated installPython() call
- `docs/api-specs/infrastructure/infrastructure-api.md` - Added Python/uv API documentation
